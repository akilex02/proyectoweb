...
<body class="text-center bg-dark">
  <nav class="navbar navbar-expand-md navbar-dark">
    <div class="container">
      <a class="navbar-brand" href="menu.html"><b>ACTUALIZAR ALUMNO</b></a>
  ...
  <div class="p-3 d-flex flex-column bg-info h-75" style="">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="cover-heading text-center text-light text-capitalize" style=" text-align: center; ">ACTUALIZAR ALUMNO</h1>
        </div>
      </div>
      <form action="validaractualizar.php" method="post">
        <div class="row">
          <div class="col-md-6">
